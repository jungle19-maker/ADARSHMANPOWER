...
export default function Testimonials() {
 ...
 <div className="absolute top-0 right-0 w-96 h-96 bg-[#F5B301]/5 -translate-y-1/2 translate-x-1/3" />
 <div className="absolute bottom-0 left-0 w-64 h-64 bg-[#F5B301]/5 translate-y-1/2 -translate-x-1/3" />
 ...
 <div
 key={i}
 className="group relative p-8 bg-white/5 border border-white/10 hover:bg-white/10 hover:border-[#F5B301]/30 transition-all duration-300 hover:-translate-y-1"
 >
 {/* Quote mark */}
 ...
 <div className="w-11 h-11 bg-[#F5B301] flex items-center justify-center text-[#23352b] font-extrabold text-sm flex-shrink-0">
 {t.initials}
 </div>
 <div>
