        ...
        <>
            ...
            >
                ...
                <div className="relative z-10 text-center px-6 max-w-5xl mx-auto py-24">
                    ...
                    {/* Eyebrow */}
                    <div className="inline-flex items-center justify-center gap-2 mb-8 px-4 py-1.5 bg-[#F5B301]/10 rounded-full border border-[#F5B301]/20 animate-fade-in-up">
                        <span className="w-2 h-2 rounded-full bg-[#F5B301] animate-pulse" />
                        <span className="text-[#F5B301] text-xs font-bold tracking-[0.2em] uppercase">
