...
export default function Hero() {
 ...
 <div className="hidden md:flex absolute right-0 top-[45%] -translate-y-1/2 flex-col z-50">
 <a 
 ...
 <div className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-[#F5B301] mb-2 group-hover:scale-110 transition-transform duration-300">
 {s.value}
 </div>
 <div className="text-[10px] sm:text-xs font-bold text-[#0B1F3A]/60 tracking-[0.1em] sm:tracking-[0.2em] uppercase">
 {s.label}
 </div>
 </div>
 ))}
