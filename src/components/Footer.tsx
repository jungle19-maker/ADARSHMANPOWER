                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                    ...
                    <div className="space-y-6 lg:col-span-1">
                        <Image
                            ...
                            alt="New Adarsh Manpower Consultant"
                            width={200}
                            height={60}
                    ...
                    <div>
                        ...
                        <ul className="space-y-4 text-sm">
                            ...
                            <li className="flex items-center gap-3">
                                ...
                                <a href="tel:+918957721120" className="text-white/50 hover:text-[#F5B301] transition-colors">
                                    +91-8957721120
                                </a>
                            </li>
                            <li className="flex items-center gap-3">
                                <Mail className="w-4 h-4 text-[#F5B301] flex-shrink-0" />
                                <a href="mailto:newadarshmanpowerconsultant@gmail.com"
                ...
                <div className="pt-8 border-t border-white/10 flex flex-col md:flex-row items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-3">
                        <div className="flex items-center gap-2 text-xs text-white/35 bg-white/5 px-4 py-2 border border-white/10">
                            ...
                            RA License: B-3395/UP/COM/100/5/11401/2026
                        </div>
                    </div>
                </div>
